...
public class RegisrtyEditor extends JFrame {
	...
	public void init(){
		...
		gbc_registryName.anchor = GridBagConstraints.EAST;
		...
		gbc_cancelButtton.insets = new Insets(0, 0, 0, 5);
		gbc_cancelButtton.gridx = 1;
		gbc_cancelButtton.gridy = 4;
