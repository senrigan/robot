...
public class CreatorOldRobotWebService {
	...
	public static String getIdRobot(String nameApp,String status,String location,
				String idApp, String retries ,String period,String startTime){
		String robotID="-1";
		try{
...
//		String deleteRobot = port.deleteRobot(""+idRobot);
	...
	public static void main(String[] args) {
		URL webServicesCreator = CreatorOldRobotWebService.getWebServicesCreator();
		System.out.println(webServicesCreator);
		boolean existeConexion = CreatorOldRobotWebService.existeConexion(webServicesCreator.toString());
